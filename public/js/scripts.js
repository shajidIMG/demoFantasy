/*!
    * Start Bootstrap - IMG Global Infotech v1.1.2 (https://shop.startbootstrap.com/product/sb-admin-pro)
  ...
  $('.nav-sticky a.nav-link[href*="#"]:not([href="javascript:void(0);"])').click(function() {
    if (
